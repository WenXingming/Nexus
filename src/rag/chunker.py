...
from src.core_contracts.rag_contracts import RagChunk, RagDocument, RagIndexError
...
class DocumentChunker:
    ...
    def _find_forward_word_break_point(self, content: str, end: int, limit: int) -> int | None:
        """向截断点右侧探测最近的词边界。
